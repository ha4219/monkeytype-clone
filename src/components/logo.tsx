export const Logo = () => {
  return (
    <a
      id="logo"
      href="/monkeytype-clone/"
      className="gap-2 grid-cols-[auto_1fr] grid mr-4"
    >
      ...
      <h1 className="text-[2rem] leading-8 relative font-logo text-nowrap hidden md:block">
        <div className="text-[.325em] leading-[.325em] absolute left-[.35em] text-secondary">
          ha4219 see
        </div>
        monkeytype-clone
      </h1>
